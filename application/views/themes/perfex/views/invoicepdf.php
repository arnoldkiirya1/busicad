...
if (count($invoice->payments) > 0 && get_option('show_transactions_on_invoice_pdf') == 1) {
    ...
    $tblhtml = '<table width="100%" border="1" bgcolor="#fff" cellspacing="0" cellpadding="5" border="0">
        ...
        <th width="25%;" style="font-weight: bold' . $border . '">' . _l('invoice_payments_table_number_heading') . '</th>
        <th width="25%;" style="font-weight: bold' . $border . '">' . _l('invoice_payments_table_mode_heading') . '</th>
        <th width="25%;" style="font-weight: bold' . $border . '">' . _l('invoice_payments_table_date_heading') . '</th>
        <th width="25%;" style="font-weight: bold' . $border . '">' . _l('invoice_payments_table_amount_heading') . '</th>
    </tr>';
    $tblhtml .= '<tbody>';
