      ...
      <tbody>
        ...
        <?php
          ...
          <tr class="treegrid-total-<?php echo new_html_entity_decode($row_index); ?> parent-node expanded tr_total">
            ...
            <td class="total_amount"><?php echo app_format_money(($total_income + $total_net_income + $total_other_income) - ($total_cost_of_sales + $total_expenses + $total_other_expenses), $currency->name); ?> </td>
